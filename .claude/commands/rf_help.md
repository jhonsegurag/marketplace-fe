Show all available RF (Reactive Framework) commands with their descriptions and usage.
...
═══════════════════════════════════════════════
  ...
  /rf_plan                 —             Generate a prioritized implementation plan from all context sources
  ...
  /rf_implement <feature>  feature name  Implement feature code from wip spec and acceptance criteria
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Flow
  ───────────────────────────────────────────────────────────────────────
  backlog → [/rf_to_do] → to_do → [/rf_wip] → wip → [/rf_implement] → wip → [/rf_review] → to_review → [/rf_done] → done
