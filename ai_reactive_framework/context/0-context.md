...
### User Types
- **Profesional** — individual job-seeker with education history, work experience, skills
...
- Dual registration flow: **Profesional** (name, surname, email, password, country) or **Empresa** (razón social, NIT/RUC, corporate email, sector, country)
