...
* Promover el crecimiento profesional y networking

## **3\. Requisitos Funcionales por Historia de Usuario**

### **HU-JSP01: Registro de Usuario Empresa-Empleado**

**Descripción**: Como visitante del sistema, quiero registrarme como empresa o profesional para acceder a las funcionalidades de la plataforma según mi tipo de usuario.

#### **Criterios de Aceptación:**

**Selección de tipo de usuario**:

* El sistema debe presentar opciones claras para registrarse como "Profesional" o "Empresa"  
...
**Descripción**: Como profesional, quiero registrar y gestionar mi información profesional completa (perfil personal, formación académica, experiencia laboral) para que las empresas puedan conocer mi trayectoria y competencias.

#### **Criterios de Aceptación:**

**Perfil Personal**:

* Foto de perfil profesional (JPG, PNG, máximo 5MB, redimensionamiento automático)  
* Información básica: título profesional, ubicación actual, disponibilidad laboral  
* Resumen profesional (máximo 500 caracteres)  
...
* Usuario profesional con sesión activa  
* Perfil básico creado durante el registro

**Postcondiciones**:

* Información profesional almacenada y indexada  
...
**Descripción**: Como profesional, quiero recibir recomendaciones personalizadas e inteligentes de ofertas de trabajo que se ajusten a mi perfil, experiencia y preferencias profesionales.
...
* Análisis de trayectoria profesional y crecimiento  
...
**Descripción**: Como profesional, quiero postularme a convocatorias de trabajo de manera eficiente y profesional, gestionando mis aplicaciones y dando seguimiento a su estado.
...
**Descripción**: Como usuario (profesional o empresa), quiero crear y compartir contenido profesional en la plataforma para construir mi marca personal/corporativa, generar networking y aportar valor a la comunidad.
...
* Políticas claras de contenido profesional  
* Penalizaciones por spam o contenido no profesional
