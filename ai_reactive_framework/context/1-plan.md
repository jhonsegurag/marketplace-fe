...
#### HU-JSP01: User Registration (Profesional / Empresa)
...
- **User type discrimination:** Add `userType: { type: String, enum: ['profesional', 'empresa'] }` to the User model. Empresa-specific fields (`razonSocial`, `nit`, `sector`) stored in the same document or a linked `CompanyProfile` document.
